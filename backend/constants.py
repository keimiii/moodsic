...
VIDEO_ID_TO_COMMENTS = {
    ...
    "60": "Scene: A man and a woman arguing and shouting at each other home, escalating quickly into the man throwing a chair and pointing aggressively while yelling at the woman. The music is happy with a calming constant beat and acapella singing, contrasting the angry screaming.",
    "79": "Scene: A lady runs into a couple on the street, seemingly having caught them as she starts to call someone else seemingly to expose them. The expressions are confrontational and guilty, it's a slightly suspenseful scene. The electronic music is kind of uplifting, doesn't suit the negative emotions",
    "81": "Scene: A cooking show with 2 ladies chopping up ingredients and chatting with each other and talking to the camera. The elevator-ish music is appropriate background music.",
    "86": "Scene: Scene from an old movie where a group of jocks are provoking a group of girls. The guys are laughing around, making fun of them while the girls seem agitated and upset, storming off at the end. The trance music kind of suits the tension in this scene.",
